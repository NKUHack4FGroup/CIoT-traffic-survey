This document records supplementary information related to the paper "A Survey on Consumer IoT Traffic: Security and Privacy". If needing to use related content, please cite this article. 
...
## Paper List
We divide existing work into 4 major categories: [Link]([https://github.com/NKUHack4FGroup/CIoT-traffic-survey/blob/main/Conference%20and%20Journal%20List.md](https://github.com/NKUHack4FGroup/CIoT-traffic-survey/blob/main/Paper%20List.md))
